# Bible Study Flywheel — Recursive Prompt Engine v2
*Optimized for Thomas Perdana / TONA Bible Study | KJV*
...
Use the KJV (King James Version) as your primary text. Cross-reference with original languages where it adds insight.
...
- Note any archaic KJV terms (thee/thou/thy, wilt, hath, doth, etc.) that may require clarification for the TONA group
...
- **Key word study:** identify 3–5 pivotal words
  ...
  - How the KJV rendering compares to the underlying original
...
- **Textual note:** the KJV is based on the Textus Receptus (NT) and Masoretic Text (OT) — flag any significant manuscript variants or translation debates, if relevant

---

### STAGE 4 — CONNECT (Fit it into the whole Bible)
- **Cross-references:** list 4–6 passages with one sentence explaining each connection (all quoted in KJV)
...
- **KJV language note:** identify any KJV phrases that may confuse modern listeners — provide a plain-English bridge without replacing the KJV text
...
- Uses elevated, reverent language befitting the KJV tradition
...
*v3 — Updated 2026-03-25 | Thomas Perdana / TONA Bible Study | KJV*
